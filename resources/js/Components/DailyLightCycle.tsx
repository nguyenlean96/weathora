                ...
                currentWeather?.sys?.sunrise ? (
                    <div className="w-full h-full overflow-hidden">
                        <div className="relative w-full h-full px-2">
                                ...
                                <div className='flex items-center justify-between'>
                                    {
                                        willSunRise ?
                                            <div className="text-end lg:text-start">
                                                <div className="text-white/60 text-sm leading-none">Sun rises</div>
                                                <div className="text-2xl text-white/80 font-bold">{getTime(sunriseDateTime)}</div>
                                            </div>
                                            :
                                            <div className="text-end lg:text-start">
                                                <div className="text-white/60 text-sm">Sun sets</div>
                            ...
                            <div className="absolute left-0 top-[70%] w-full border-t-2 z-0 bg-gradient-to-b from-slate-600/20 via-slate-800/40 to-gray-800/80 h-14"></div>
                            <div
                                style={{
                            ...
                            >
                                <svg fill="none" xmlns="http://www.w3.org/2000/svg"
                                    className="absolute top-16 left-0 xl:right-0 z-0 opacity-60 w-full"
                                    ref={animationDivRef}
                                >
